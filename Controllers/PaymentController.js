    ...
    //   database comes here
       ...
       export const  cancelSubscription = catchAsyncError(async(req,res,next)=>{
        ...
        res.status(200).json({
          success:true,
          message:
          refund?"Subscription cancelled, You will recieve full refund within 7 days.":"Subscription cancelled, Now refund initiated as subscription was cancelled after 7 days."
